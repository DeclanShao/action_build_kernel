...
#make O=out
make O=out CC="ccache clang" CXX="ccache clang++" CROSS_COMPILE=$GITHUB_WORKSPACE/kernel/prelude-clang/bin/aarch64-linux-gnu- CROSS_COMPILE_ARM32=$GITHUB_WORKSPACE/kernel/prelude-clang/bin/arm-linux-gnueabi- LD=ld.lld tb8704_defconfig
make O=out
